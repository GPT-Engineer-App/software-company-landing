  ...
  return (
    <Container maxW="container.xl" p={4}>
      ...
      <HStack spacing={8} mt={16} justifyContent="center">
        ...
        <Box maxW="sm" borderWidth="1px" borderRadius="lg" overflow="hidden">
          <Image src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHxjbG91ZCUyMHNlcnZpY2VzfGVufDB8fHx8MTcxNzU0MjI3Nnww&ixlib=rb-4.0.3&q=80&w=1080" alt="Cloud Services" />
          <Box p={6}>
            <Heading as="h3" size="md">
              Cloud Services
            </Heading>
        ...
        <Box maxW="sm" borderWidth="1px" borderRadius="lg" overflow="hidden">
          <Image src="https://images.unsplash.com/photo-1516321318423-f06f85e504b3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w1MDcxMzJ8MHwxfHNlYXJjaHwxfHx0ZWNoJTIwc3VwcG9ydHxlbnwwfHx8fDE3MTc1NDIyNzd8MA&ixlib=rb-4.0.3&q=80&w=1080" alt="Tech Support" />
          <Box p={6}>
            <Heading as="h3" size="md">
              24/7 Tech Support
            </Heading>
